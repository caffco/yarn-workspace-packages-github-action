...
;(() => {
  ...
  /******/ var __webpack_modules__ = {
      ...
      const readJsonFile = (pathToFile) =>
        __awaiter(void 0, void 0, void 0, function* () {
          const buffer = yield new Promise((resolve, reject) =>
            fs_1.default.readFile(pathToFile, (error, data) =>
    ...
    /***/ 928: /***/ (
      ...
      Object.defineProperty(exports, '__esModule', { value: true })
      exports.setGithubActionOutputFromResults =
      ...
      function setGithubActionOutputFromResults({ packageNames }) {
        ;(0, core_1.debug)(
          `Packages in this workspace: ${packageNames.join(', ')}`
        )
    ...
    /***/ 109: /***/ function (
      ...
      function main() {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          const rootPackage = yield (0, fs_1.readJsonFile)(
            path_1.default[resolveFunction](
              options.repositoryRootPath,
              'package.json'
            )
          )
          const packageFolderRelativePaths = rootPackage.workspaces.packages
          const packageNames = yield Promise.all(
            packageFolderRelativePaths.map((relativePath) =>
              __awaiter(this, void 0, void 0, function* () {
                const packageJsonAbsolutePath = path_1.default[resolveFunction](
                  options.repositoryRootPath,
                  relativePath,
                  'package.json'
                )
                const packageJson = yield (0, fs_1.readJsonFile)(
